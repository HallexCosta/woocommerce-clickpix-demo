...
class FormLeadModel {
  public static $cptTitleSingular = 'Formulário Parceiro';
  public static $cptTitlePlural = 'Formulário Parceiros';
  public static $cptNameSingular = 'form-lead';
  public static $cptNamePlural = 'form-leads';
  public static $cptLabelSingular = 'Lead';
  public static $cptLabelPlural = 'Leads';
  public static $cptAddNewItem = 'Adicionar novo parceiro';
  public static $cptAllItems = 'Todas os parceiros';
  public static $cptNotFound = 'Nenhum parceiro encontrado';
  public static $cptDescription = 'Inscritos através do formulário parceiro';
